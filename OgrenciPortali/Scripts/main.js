(function() {
    ...
    ScheduleTemplate.prototype.placeEvents = function() {
        ...
        for (var i = 0; i < this.singleEvents.length; i++) {
            ...
            this.singleEvents[i].setAttribute('style',
    ...
    ScheduleTemplate.prototype.openModal = function(target) {
        ...
        if (mq == 'mobile') {
            ...
            self.modalBodyBg.setAttribute('style',
                'height:' +
                eventHeight +
            ...
            self.modalHeaderBg.setAttribute('style',
                'height: ' +
                eventHeight +
                'px; width: ' +
                eventWidth +
            ...
            self.modalHeaderBg.addEventListener('transitionend',
                function cb() {
    ...
    ScheduleTemplate.prototype.loadEventContent = function (content, target) {
        ...
        var description = content; // 'content' artık ders açıklamasını içeriyor.

        var finalContentHTML = '';

        // Eğitmen bilgisi varsa ekle
        if (teacherName && teacherName.trim() !== '') {
            finalContentHTML += '<p><strong>Eğitmen:</strong> ' + teacherName + '</p>';
        }
        ...
        // Ders açıklaması varsa ekle
        if (description && description.trim() !== '') {
            finalContentHTML += '<div>' + description + '</div>';
        }

        // Eğer içerik yoksa varsayılan bir mesaj göster
        if (finalContentHTML.trim() === '') {
            finalContentHTML = '<p>Bu ders için detaylı bilgi bulunmamaktadır.</p>';
        }
